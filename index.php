...
<style>
    ...
    /* Add an blue color to all icons and set the font-size */
    .logo-small {
        color: blue;
        font-size: 70px;
    }
...
<div class="jumbotron">
    <div class="container text-center">
        <h1>Driverless</h1>
        <p>We offer all of the latest and high quality self-driving cars in the world.</p>
...
<div class="container">
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
        ...
        <!-- Wrapper for slides -->
        <div class="carousel-inner" aria-label="slide show of our new vehicles" role="listbox">
...
<div class="container-fluid text-center">
    ...
    <div id="myCarousel" class="carousel slide text-center" data-ride="carousel">
        ...
        <!-- Wrapper for slides -->
        <div  style="background-color: darkgrey" class="carousel-inner">
            <div class="item active" >
            ...
            <div class="item">
                <h4 class="feedback">"Could I... BE any more happy with this company?"<br><span>Chandler Bing, Actor, FriendsAlot</span></h4>
            </div>
        </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="" method="post">
                    <div class="form-group">
                        <label for="news-name">FullName</label>
                        <input id="news-name" class="form-control" type="text" placeholder="John Doe" required/>
                    </div>
                    <div class="form-group">
                        <label for="news">Email</label>
                        <input  id="news" class="form-control" type="email" placeholder="email@example.com" required/>
                    </div>
                    <div class="form-group">
